...
config.GaMutationRelease = 6;
config.GaMutationRouting = 6;
config.GaRandomImmigrantFraction = 0.20;
config.GaLocalReleaseStep = 4;
config.GaLocalRoutingStep = 4;
config.GaLocalNeighborCount = 4;
config.GaRandomSeed = [];
